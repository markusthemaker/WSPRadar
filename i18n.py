...
T = {
    "en": {
        ...
        "cbar_comp": "Median Delta Normalized SNR vs. Benchmark (1S=6dB)",
        ...
        "lbl_hist_x_comp": "{station_type} Median of Delta Norm. SNR (dB)",
        "lbl_hours": "Last hours back (Note: DB updated every 15 min)",
        ...
        "lbl_no_joint": "No joint spots available in this segment to calculate a Delta SNR histogram.",
        ...
        "tbl_col_km": "km",
        "tbl_col_loc": "Locator",
        "tbl_col_med_delta": "Median Delta SNR (dB)",
        ...
        "tbl_col_delta_snr": "Delta SNR (dB)",
    ...
    "de": {
        ...
        "cbar_comp": "Median Delta normiertes SNR vs. Referenz (1S=6dB)",
        ...
        "lbl_hist_x_comp": "{station_type} Median Delta normiertes SNR (dB)",
        "lbl_hours": "Letzten Stunden zurück (DB Update alle 15 Min)",
        "lbl_insights": "📡 Station Insights",
        ...
        "lbl_no_joint": "Keine gemeinsamen Spots in diesem Segment für ein Delta-SNR-Histogramm vorhanden.",
        "lbl_qth": "QTH Locator (4-6 Chars)",
