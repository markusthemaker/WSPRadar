...
T = {
    "en": {
        ...
        "hlp_benchmark_offset_db": "Added to the benchmark/reference SNR before \u0394 SNR is calculated. Applies to compare maps only.",
        "lbl_band": "Operating Band",
        "lbl_benchmark_offset_db": "Benchmark SNR Offset (dB)",
        ...
        "txt_benchmark_offset_note": "Benchmark SNR Offset: {offset:+.1f} dB applied to benchmark/reference SNR before \u0394 SNR calculation.",
    ...
    "de": {
        ...
        "hlp_benchmark_offset_db": "Wird vor der Berechnung von \u0394 SNR zum Benchmark-/Referenz-SNR addiert. Gilt nur f\u00fcr Vergleichskarten.",
        ...
        "txt_benchmark_offset_note": "Benchmark SNR Offset: {offset:+.1f} dB wird vor der \u0394-SNR-Berechnung auf das Benchmark-/Referenz-SNR angewendet.",
