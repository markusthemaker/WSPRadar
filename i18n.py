...
T = {
    "en": {
        ...
        "btn_prepare_regression_data": "regression data",
        "btn_download_regression_data": "download regression data",
        "msg_preparing_all_results": "Preparing high-resolution result package...",
        "msg_preparing_regression_data": "Preparing regression data...",
        "warn_no_regression_data": "Regression data is no longer available for this run.",
        ...
        "hlp_benchmark_offset_db": "Added to the benchmark/reference SNR before \u0394 SNR is calculated. Applies to compare maps only. If a calibration run shows target-reference = +1.6 dB, enter +1.6 dB.",
        "lbl_band": "Operating Band",
        "lbl_benchmark_offset_db": "Benchmark SNR Correction (dB)",
        ...
        "txt_benchmark_offset_note": "Benchmark SNR Correction: {offset:+.1f} dB applied to benchmark/reference SNR before \u0394 SNR calculation.",
    ...
    "de": {
        ...
        "btn_prepare_regression_data": "Regressionsdaten",
        "btn_download_regression_data": "Regressionsdaten herunterladen",
        "msg_preparing_all_results": "Hochaufloesendes Ergebnispaket wird vorbereitet...",
        "msg_preparing_regression_data": "Regressionsdaten werden vorbereitet...",
        "warn_no_regression_data": "Regressionsdaten sind fuer diesen Lauf nicht mehr verfuegbar.",
        ...
        "hlp_benchmark_offset_db": "Wird vor der Berechnung von \u0394 SNR zum Benchmark-/Referenz-SNR addiert. Gilt nur f\u00fcr Vergleichskarten. Wenn ein Kalibrierlauf Ziel-Referenz = +1,6 dB ergibt, verwende +1,6 dB.",
        "lbl_band": "Frequenzband",
        "lbl_benchmark_offset_db": "Benchmark-SNR-Korrektur (dB)",
        ...
        "txt_benchmark_offset_note": "Benchmark-SNR-Korrektur: {offset:+.1f} dB wird vor der \u0394-SNR-Berechnung auf das Benchmark-/Referenz-SNR angewendet.",
