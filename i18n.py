...
T = {
    "en": {
        ...
        'fig_success_temporal_title_rx': "RX Success Temporal Evidence: Target {callsign}",
        'fig_success_temporal_title_tx': "TX Success Temporal Evidence: Target {callsign}",
        'fig_success_temporal_snr_title_rx': "RX Success Temporal SNR Evidence: Target {callsign}",
        'fig_success_temporal_snr_title_tx': "TX Success Temporal SNR Evidence: Target {callsign}",
        'fig_success_selected_station_snr_title_rx': "RX Success Selected Station SNR Evidence: {station} ({locator})",
        'fig_success_selected_station_snr_title_tx': "TX Success Selected Station SNR Evidence: {station} ({locator})",
        'fig_success_selected_station_temporal_title_rx': "RX Success Selected Station Temporal Evidence: {station} ({locator})",
        'fig_success_selected_station_temporal_title_tx': "TX Success Selected Station Temporal Evidence: {station} ({locator})",
        ...
        'fig_success_consistency_title_rx': "RX Success Rate by TX-Station Distance",
        'fig_success_consistency_title_tx': "TX Success Rate by RX-Station Distance",
        ...
        'fig_success_rate_y': "Success Rate (%)",
        ...
        'fig_success_station_balanced': "Station-balanced",
        'fig_success_observation_level': "Observation-level",
        ...
        'fig_success_locator_precision_note': "Calculated distance inherits the precision of reported locators; Grid-4 is not survey-grade positioning.",
        ...
        "hdr_results_success_evidence": "Success Evidence",
        "sub_results_success_evidence": "Reach, consistency and successful-signal strength by calculated distance for the active scope.",
        "sub_results_success_temporal": "Successful signal-strength deviations, station-balanced evidence and confirmed opportunities shown chronologically and by UTC hour.",
        ...
        "fmt_success_selected_context": "{station} ({locator}) · {distance_km} km · {azimuth_degrees}° {direction} · {confirmed_opportunities} {opportunity_unit} · Success Rate {success_rate}% · Median successful Target SNR {median_snr}",
        "abbr_compass_east": "E",
        ...
        "success_rx_subtext": "Heard by Target | Heard by others only | Click a row for evidence",
        "success_rx_show_counter": "Show Heard by others only stations",
        ...
        "success_tx_subtext": "Target heard | Other signals heard only | Click a row for evidence",
        "success_tx_show_counter": "Show Other signals heard only stations",
        ...
        "fig_rx_abs": "RX Success: {callsign} — Heard by Target vs. Heard by Others Only",
        "fig_rx_comp": "RX Compare: {callsign} (Target) vs. {comp_title}",
        "fig_tx_abs": "TX Success: {callsign} — Target Heard vs. Other Signals Heard Only",
        ...
        "hlp_min_opportunities_rx": """In RX Success, a remote TX station qualifies only after this many confirmed opportunities. Each opportunity is classified as Heard by Target or Heard by others only. A Target decode without independent confirmation remains auditable but does not enter the Success Rate.""",
        "hlp_min_opportunities_tx": """In TX Success, a remote RX station qualifies only after this many confirmed opportunities. Each opportunity is classified as Target heard or Other signals heard only. A Target report without independent RX-activity confirmation remains auditable but does not enter the Success Rate.""",
        ...
        "hlp_min_stations_success_rx": """An RX Success map segment is displayed only when it contains at least this many qualifying TX stations. A station qualifies after meeting the confirmed-opportunity threshold above, whether its outcomes are Heard by Target or Heard by others only.""",
        "hlp_min_stations_success_tx": """A TX Success map segment is displayed only when it contains at least this many qualifying RX stations. A station qualifies after meeting the confirmed-opportunity threshold above, whether its outcomes are Target heard or Other signals heard only.""",
        ...
        "tbl_col_confirmed_opportunities": "Confirmed opportunities",
        "tbl_col_success_rate": "Success Rate (%)",
        "tbl_col_success_snr": "Median Target SNR (dB @ 30 dBm)",
        "tbl_col_success_snr_display": "Median successful Target SNR (dB @ 30 dBm)",
        "fmt_results_success_station_summary": "Stations: {success_label} {success_station_count} · {counter_label} {counter_station_count} · Success Rate {station_balanced_rate:.1f}%",
        "fmt_results_success_opportunity_summary": "Opportunities: {success_label} {success_count} · {counter_label} {counter_count} · Success Rate {observation_level_rate:.1f}%",
    ...
    "de": {
        ...
        'fig_success_temporal_title_rx': "RX Success — Zeitliche Evidenz: Target {callsign}",
        'fig_success_temporal_title_tx': "TX Success — Zeitliche Evidenz: Target {callsign}",
        'fig_success_temporal_snr_title_rx': "RX Success — Zeitliche SNR-Evidenz: Target {callsign}",
        'fig_success_temporal_snr_title_tx': "TX Success — Zeitliche SNR-Evidenz: Target {callsign}",
        'fig_success_selected_station_snr_title_rx': "RX Success — SNR-Evidenz der ausgewählten Station: {station} ({locator})",
        'fig_success_selected_station_snr_title_tx': "TX Success — SNR-Evidenz der ausgewählten Station: {station} ({locator})",
        'fig_success_selected_station_temporal_title_rx': "RX Success — Zeitliche Evidenz der ausgewählten Station: {station} ({locator})",
        'fig_success_selected_station_temporal_title_tx': "TX Success — Zeitliche Evidenz der ausgewählten Station: {station} ({locator})",
        ...
        'fig_success_consistency_title_rx': "RX Success Rate nach Entfernung der TX-Station",
        'fig_success_consistency_title_tx': "TX Success Rate nach Entfernung der RX-Station",
        ...
        'fig_success_station_balanced': "Stationsgleichgewichtet",
        'fig_success_observation_level': "Beobachtungsebene",
        'fig_success_median': "Median",
        'fig_success_iqr': "IQR",
        ...
        'fig_success_locator_precision_note': "Die berechnete Entfernung übernimmt die Genauigkeit der gemeldeten Locator; Grid-4 ist keine vermessungsgenaue Positionierung.",
        ...
        "hdr_results_success_evidence": "Success-Evidenz",
        "sub_results_success_evidence": "Reichweite, Zuverlässigkeit und Stärke erfolgreicher Signale nach berechneter Entfernung im aktiven Bereich.",
        "sub_results_success_temporal": "Abweichungen erfolgreicher Signalstärken, stationsgleichgewichtete Evidenz und bestätigte Gelegenheiten, chronologisch und nach UTC-Stunde dargestellt.",
        ...
        "fmt_success_selected_context": "{station} ({locator}) · {distance_km} km · {azimuth_degrees}° {direction} · {confirmed_opportunities} {opportunity_unit} · Success Rate {success_rate}% · Median des erfolgreichen Target-SNR {median_snr}",
        "abbr_compass_east": "O",
        ...
        "success_rx_subtext": "Vom Target gehört | Nur von anderen gehört | Klick auf eine Zeile für Evidenz",
        "success_rx_show_counter": "Stationen „Nur von anderen gehört“ anzeigen",
        ...
        "success_tx_subtext": "Target gehört | Nur andere Signale gehört | Klick auf eine Zeile für Evidenz",
        "success_tx_show_counter": "Stationen „Nur andere Signale gehört“ anzeigen",
        ...
        "fig_rx_abs": "RX Success: {callsign} — Vom Target gehört vs. nur von anderen gehört",
        "fig_rx_comp": "RX Vergleich: {callsign} (Target) vs. {comp_title}",
        "fig_tx_abs": "TX Success: {callsign} — Target gehört vs. nur andere Signale gehört",
        "abs_rx_counter": "Elsewhere",
        "abs_rx_counter_short": "E",
        "abs_rx_target_column": "Target (T)",
        "abs_rx_pair": "Target+Elsewhere",
        ...
        "hlp_min_opportunities_rx": """Bei RX Success qualifiziert sich eine entfernte TX-Station erst ab dieser Anzahl bestätigter Gelegenheiten. Jede Gelegenheit wird als Vom Target gehört oder Nur von anderen gehört klassifiziert. Ein Target-Decode ohne unabhängige Bestätigung bleibt prüfbar, fließt aber nicht in die Success Rate ein.""",
        "hlp_min_opportunities_tx": """Bei TX Success qualifiziert sich eine entfernte RX-Station erst ab dieser Anzahl bestätigter Gelegenheiten. Jede Gelegenheit wird als Target gehört oder Nur andere Signale gehört klassifiziert. Ein Target-Report ohne unabhängige Bestätigung der RX-Aktivität bleibt prüfbar, fließt aber nicht in die Success Rate ein.""",
        ...
        "hlp_min_stations_success_rx": """Ein RX-Success-Kartensegment wird nur angezeigt, wenn es mindestens diese Anzahl qualifizierender TX-Stationen enthält. Eine Station qualifiziert sich, wenn sie die oben festgelegte Schwelle bestätigter Gelegenheiten erfüllt—unabhängig davon, ob ihre Outcomes Vom Target gehört oder Nur von anderen gehört lauten.""",
        "hlp_min_stations_success_tx": """Ein TX-Success-Kartensegment wird nur angezeigt, wenn es mindestens diese Anzahl qualifizierender RX-Stationen enthält. Eine Station qualifiziert sich, wenn sie die oben festgelegte Schwelle bestätigter Gelegenheiten erfüllt—unabhängig davon, ob ihre Outcomes Target gehört oder Nur andere Signale gehört lauten.""",
        ...
        "tbl_col_success_station_rx": "TX-Station",
        "tbl_col_success_station_tx": "RX-Station",
        "tbl_col_confirmed_opportunities": "Bestätigte Gelegenheiten",
        "tbl_col_success_rate": "Success Rate (%)",
        "tbl_col_success_snr": "Median Target-SNR (dB @ 30 dBm)",
        "tbl_col_success_snr_display": "Median des erfolgreichen Target-SNR (dB @ 30 dBm)",
        "fmt_results_success_station_summary": "Stationen: {success_label} {success_station_count} · {counter_label} {counter_station_count} · Success Rate {station_balanced_rate:.1f}%",
        "fmt_results_success_opportunity_summary": "Gelegenheiten: {success_label} {success_count} · {counter_label} {counter_count} · Success Rate {observation_level_rate:.1f}%",
...
RESULT_GUIDANCE = {
    "en": {
        ...
        "sections": {
            "context_rx_success": {
                "read": """RX Success shows how consistently the <strong class="defined-term">Target</strong> receiver decoded remote transmitters within independently confirmed opportunities. A <strong class="defined-term">confirmed opportunity</strong> exists when the Target receiver is active and another eligible receiver decodes the same transmitter in the same WSPR cycle. The outcome is <strong class="defined-term">Heard by Target</strong> when the Target also decodes it, and <strong class="defined-term">Heard by others only</strong> when the Target does not. RX Success Rate is the share of confirmed opportunities heard by the Target. A Target decode without the independent confirmation remains auditable as Target-only evidence but does not enter this rate. Repetition across many transmitters, directions and times turns individual spots into a broader view of receiver performance.""",
                "limits": """This is conditional performance within independently confirmed archive opportunities, not an absolute receiver-sensitivity measurement. Missed signals have no recorded Target SNR, and the result does not identify why an individual decode failed.""",
            },
            "context_tx_success": {
                "read": """TX Success shows how consistently the <strong class="defined-term">Target</strong> transmitter was decoded by remote receivers independently shown to be active. A <strong class="defined-term">confirmed opportunity</strong> exists when the Target is known to be transmitting and the remote RX station decodes another qualifying signal on the same band. The outcome is <strong class="defined-term">Target heard</strong> when that receiver also decodes the Target, and <strong class="defined-term">Other signals heard only</strong> when it does not. TX Success Rate is the share of confirmed opportunities in which the Target was heard. A Target decode without independent RX-activity confirmation remains auditable but does not enter this rate. Repetition across many receivers, directions and times builds a broader picture than a single spot report.""",
                "limits": """This is conditional reach among independently confirmed active receivers, not a measurement of radiated power or antenna efficiency. It cannot explain why an individual receiver missed the Target.""",
            },
            "context_rx_compare": {
            ...
            "benchmark_hardware": {
                "read": """The <strong class="defined-term">Hardware A/B benchmark</strong> compares two controlled paths operating within the shared Grid-4—for example antennas, feedlines, radios or complete chains at the same station. Sharing the site and much of the surrounding system removes many differences that affect a station-to-station comparison. When only the intended path changes, repeated evidence from many remote stations can reveal small, directional or time-dependent differences.""",
            ...
            "benchmark_reference": {
                "read": """The <strong class="defined-term">Reference Station benchmark</strong> compares the complete Target station with one known <strong class="defined-term">Reference</strong> station selected by its exact callsign and independently configured Reference Grid-4. It is useful for tracking a repeatable whole-station difference across directions, distances and time.""",
            ...
            "map_success_rx": {
                "read": """Map View is the geographic overview of conditional <strong class="defined-term">RX Success Rate</strong>. Each colored distance-and-direction sector first calculates one Success Rate for every qualifying TX station and then gives every station one equal vote. This is the <strong class="defined-term">station-balanced</strong> result. Dark-green markers show TX stations <strong class="defined-term">Heard by Target</strong> at least once; light-grey markers show stations <strong class="defined-term">Heard by others only</strong>. The footer separates breadth from repetition: <strong class="defined-term">STATIONS</strong> counts station identities, while <strong class="defined-term">OPPORTUNITIES</strong> counts individual confirmed outcomes. Read sector color together with both footer rows—a clear rate supported by many stations and many opportunities is more persuasive than the same color on a narrow evidence base.""",
            ...
            "map_success_tx": {
                "read": """Map View is the geographic overview of conditional <strong class="defined-term">TX Success Rate</strong>. Each colored distance-and-direction sector first calculates one Success Rate for every qualifying RX station and then gives every station one equal vote. This is the <strong class="defined-term">station-balanced</strong> result. Dark-green markers show RX stations at which the <strong class="defined-term">Target was heard</strong> at least once; light-grey markers show stations where <strong class="defined-term">Other signals were heard only</strong>. The footer separates breadth from repetition: <strong class="defined-term">STATIONS</strong> counts receiver identities, while <strong class="defined-term">OPPORTUNITIES</strong> counts individual confirmed outcomes. Read sector color together with both footer rows—a clear rate supported by many receivers and many opportunities is more persuasive than the same color on a narrow evidence base.""",
            ...
            "segment_success_rx": {
                "read": """Segment Inspector turns the map into a focused geographic subset. The selected distance ranges and directions define the <strong class="defined-term">active scope</strong> inherited by every following figure and station table. The station summary separates TX stations <strong class="defined-term">Heard by Target</strong> from those <strong class="defined-term">Heard by others only</strong> and reports the station-balanced Success Rate. The opportunity summary counts the same two outcomes at observation level and reports the pooled Success Rate. Compare the two Success Rates directly: close values mean high-volume stations broadly agree with the wider station population, while divergence means station mix or evidence volume changes the result. Station count shows breadth across radio paths, while confirmed opportunities show repeated depth.""",
            ...
            "segment_success_tx": {
                "read": """Segment Inspector turns the map into a focused geographic subset. The selected distance ranges and directions define the <strong class="defined-term">active scope</strong> inherited by every following figure and station table. The station summary separates RX stations where the <strong class="defined-term">Target was heard</strong> from stations where <strong class="defined-term">Other signals were heard only</strong> and reports the station-balanced Success Rate. The opportunity summary counts the same two outcomes at observation level and reports the pooled Success Rate. Compare the two Success Rates directly: close values mean high-volume receivers broadly agree with the wider receiver population, while divergence means station mix or evidence volume changes the result. Station count shows breadth, while confirmed opportunities show repeated depth.""",
            ...
            "station_insights_success_rx": {
                "read": """Station Insights identifies the TX stations behind the scoped RX Success result. Each row represents one reported callsign-plus-locator identity. Read <strong class="defined-term">Heard by Target</strong>, <strong class="defined-term">Heard by others only</strong>, confirmed opportunities and Success Rate together. A high rate based on many opportunities carries more descriptive depth than the same rate based on only a few. Median successful Target SNR describes only the decodes that succeeded; a less-negative value is stronger relative to noise. Table filters, sorting and row selection change only the displayed station view and do not recalculate the Segment Inspector figures.""",
            ...
            "station_insights_success_tx": {
                "read": """Station Insights identifies the RX stations behind the scoped TX Success result. Each row represents one reported callsign-plus-locator identity. Read <strong class="defined-term">Target heard</strong>, <strong class="defined-term">Other signals heard only</strong>, confirmed opportunities and Success Rate together. A high rate based on many opportunities carries more descriptive depth than the same rate based on only a few. Median successful Target SNR describes only successful Target reports; a less-negative value is stronger relative to noise. Table filters, sorting and row selection change only the displayed station view and do not recalculate the Segment Inspector figures.""",
            ...
            "drilldown_success_rx": {
                "read": """Drill-Down Data is the audit trail from RX Success back to the contributing WSPR cycles. It shows processed evidence after WSPRadar’s eligibility rules and filters. Outcomes identify <strong class="defined-term">Heard by Target</strong>, <strong class="defined-term">Heard by others only</strong>, and Target decodes without the independent confirmation required for the Success Rate. Use exact UTC time, TX-station identity and outcome to reconcile the numerator and denominator with the displayed summaries. Table filters change only the visible rows.""",
            ...
            "drilldown_success_tx": {
                "read": """Drill-Down Data is the audit trail from TX Success back to the contributing WSPR cycles. It shows processed evidence after WSPRadar’s eligibility rules and filters. Outcomes identify <strong class="defined-term">Target heard</strong>, <strong class="defined-term">Other signals heard only</strong>, and Target reports without the independent RX-activity confirmation required for the Success Rate. Use exact UTC time, RX-station identity and outcome to reconcile the numerator and denominator with the displayed summaries. Table filters change only the visible rows.""",
    ...
    "de": {
        ...
        "sections": {
            ...
            "map_success_rx": {
                "read": """Die Kartenansicht ist der geografische Überblick über die bedingte <strong class="defined-term">RX Success Rate</strong>. Jedes farbige Entfernungs- und Richtungssegment berechnet zunächst eine Success Rate für jede qualifizierende TX-Station und gibt anschließend jeder Station genau eine Stimme. Dies ist das <strong class="defined-term">stationsgleichgewichtete</strong> Ergebnis. Dunkelgrüne Marker zeigen TX-Stationen, die mindestens einmal <strong class="defined-term">Vom Target gehört</strong> wurden. Hellgraue Marker zeigen Stationen, die <strong class="defined-term">Nur von anderen gehört</strong> wurden. Der Fußbereich trennt Breite von Wiederholung: <strong class="defined-term">STATIONEN</strong> zählt Stationsidentitäten, <strong class="defined-term">GELEGENHEITEN</strong> zählt einzelne bestätigte Outcomes. Lies Segmentfarbe und beide Fußzeilen zusammen: Eine klare Rate mit vielen Stationen und Gelegenheiten ist aussagekräftiger als dieselbe Farbe auf schmaler Evidenzbasis.""",
            ...
            "map_success_tx": {
                "read": """Die Kartenansicht ist der geografische Überblick über die bedingte <strong class="defined-term">TX Success Rate</strong>. Jedes farbige Entfernungs- und Richtungssegment berechnet zunächst eine Success Rate für jede qualifizierende RX-Station und gibt anschließend jeder Station genau eine Stimme. Dies ist das <strong class="defined-term">stationsgleichgewichtete</strong> Ergebnis. Dunkelgrüne Marker zeigen RX-Stationen, an denen das <strong class="defined-term">Target gehört</strong> wurde. Hellgraue Marker zeigen Stationen, an denen <strong class="defined-term">Nur andere Signale gehört</strong> wurden. Der Fußbereich trennt Breite von Wiederholung: <strong class="defined-term">STATIONEN</strong> zählt Empfängeridentitäten, <strong class="defined-term">GELEGENHEITEN</strong> zählt einzelne bestätigte Outcomes. Lies Segmentfarbe und beide Fußzeilen zusammen: Eine klare Rate mit vielen Empfängern und Gelegenheiten ist aussagekräftiger als dieselbe Farbe auf schmaler Evidenzbasis.""",
            ...
            "success_evidence_tx": {
                "read": """Success-Evidenz betrachtet die qualifizierende RX-Stationspopulation auf drei ergänzende Arten nach der berechneten Entfernung vom Target-QTH. <strong class="defined-term">RX-Stationen, die das Target mindestens einmal hörten, nach Entfernung</strong> zeigt, ob das Target den jeweiligen Teil der aktiven Empfängerpopulation im gewählten UTC-Zeitraum überhaupt erreichte. <strong class="defined-term">TX Success Rate nach Entfernung der RX-Station</strong> zeigt, wie zuverlässig das Target gehört wurde, und vergleicht gleiche Stationsgewichtung mit gepoolter Gelegenheitsgewichtung. <strong class="defined-term">Erfolgreiches Target-SNR nach Entfernung der RX-Station</strong> gibt zunächst jeder RX-Station einen Median erfolgreicher Target-Reports und fasst danach diese Stationsmediane in jedem exakten Entfernungs-Bin zusammen. Lies die Panels von links nach rechts: Reichweite, wiederholte Zuverlässigkeit und Signalstärke bei erfolgreichem Decode. Stations- und Gelegenheitszahlen zeigen die Evidenz hinter jedem Bin.""",
            ...
            "station_insights_success_rx": {
                "read": """Station Insights zeigt die TX-Stationen hinter dem RX-Success-Ergebnis im aktiven Bereich. Jede Zeile steht für eine gemeldete Kombination aus Rufzeichen und Locator. Lies <strong class="defined-term">Vom Target gehört</strong>, <strong class="defined-term">Nur von anderen gehört</strong>, bestätigte Gelegenheiten und Success Rate zusammen. Eine hohe Rate mit vielen Gelegenheiten besitzt mehr beschreibende Tiefe als dieselbe Rate auf Basis weniger Gelegenheiten. Der Median des erfolgreichen Target-SNR beschreibt nur die Decodes, die gelungen sind; ein weniger negativer Wert ist relativ zum Rauschen stärker. Tabellenfilter, Sortierung und Zeilenauswahl verändern nur die Stationsansicht und berechnen die Segment-Abbildungen nicht neu.""",
            ...
            "station_insights_success_tx": {
                "read": """Station Insights zeigt die RX-Stationen hinter dem TX-Success-Ergebnis im aktiven Bereich. Jede Zeile steht für eine gemeldete Kombination aus Rufzeichen und Locator. Lies <strong class="defined-term">Target gehört</strong>, <strong class="defined-term">Nur andere Signale gehört</strong>, bestätigte Gelegenheiten und Success Rate zusammen. Eine hohe Rate mit vielen Gelegenheiten besitzt mehr beschreibende Tiefe als dieselbe Rate auf Basis weniger Gelegenheiten. Der Median des erfolgreichen Target-SNR beschreibt nur erfolgreiche Target-Reports; ein weniger negativer Wert ist relativ zum Rauschen stärker. Tabellenfilter, Sortierung und Zeilenauswahl verändern nur die Stationsansicht und berechnen die Segment-Abbildungen nicht neu.""",
            ...
            "drilldown_success_rx": {
                "read": """Die Drill-Down-Daten sind der Prüfpfad vom RX-Success-Ergebnis zurück zu den beitragenden WSPR-Zyklen. Sie zeigen verarbeitete Evidenz nach den Eignungsregeln und Filtern von WSPRadar. Outcomes unterscheiden <strong class="defined-term">Vom Target gehört</strong>, <strong class="defined-term">Nur von anderen gehört</strong> und Target-Decodes ohne die unabhängige Bestätigung, die für die Success Rate erforderlich ist. Nutze exakte UTC-Zeit, TX-Stationsidentität und Outcome, um Zähler und Nenner mit den angezeigten Zusammenfassungen abzugleichen. Tabellenfilter verändern nur die sichtbaren Zeilen.""",
            ...
            "drilldown_success_tx": {
                "read": """Die Drill-Down-Daten sind der Prüfpfad vom TX-Success-Ergebnis zurück zu den beitragenden WSPR-Zyklen. Sie zeigen verarbeitete Evidenz nach den Eignungsregeln und Filtern von WSPRadar. Outcomes unterscheiden <strong class="defined-term">Target gehört</strong>, <strong class="defined-term">Nur andere Signale gehört</strong> und Target-Reports ohne die unabhängige Bestätigung der RX-Aktivität, die für die Success Rate erforderlich ist. Nutze exakte UTC-Zeit, RX-Stationsidentität und Outcome, um Zähler und Nenner mit den angezeigten Zusammenfassungen abzugleichen. Tabellenfilter verändern nur die sichtbaren Zeilen.""",
...
- **Joint evidence** means that comparable evidence is available for both sides: the same transmission was decoded by both RX sides, corresponding Target and Reference reports were made at the same receiving station, or a scheduled Target–Reference pair is available for sequential TX.""",
        ...
        "options": {
            "use_cases": {
                "rx_success": {
                    "label": "RX Success",
                    "description": """Choose this to evaluate your receiver without a Reference. WSPRadar finds confirmed opportunities in which another eligible receiver decoded the same remote transmitter in the same WSPR cycle. The outcome is Heard by Target when the Target receiver also decoded it, and Heard by others only when it did not. RX Success Rate is the share of confirmed opportunities with the outcome Heard by Target. The results show stand-alone Target performance, not a Reference comparison.""",
                },
                "tx_success": {
                    "label": "TX Success",
                    "description": """Choose this to evaluate your transmitter without a Reference. During cycles in which the Target is known to be transmitting, WSPRadar forms a confirmed opportunity when a remote RX station decodes another qualifying signal on the same band. The outcome is Target heard when that receiver also decodes the Target, and Other signals heard only when it does not. TX Success Rate is the share of confirmed opportunities with the outcome Target heard. The results show stand-alone Target performance, not a Reference comparison.""",
                },
                "rx_compare": {
                    "label": "RX Compare",
...
- **Joint-Evidenz** bedeutet, dass für beide Seiten vergleichbare Daten vorliegen: dieselbe Aussendung wurde von beiden RX-Seiten dekodiert, an derselben Empfangsstation liegen passende Reports für Target und Referenz vor, oder bei sequenziellem TX gibt es ein geplantes Target–Referenz-Paar.""",
        ...
        "options": {
            "use_cases": {
                "rx_success": {
                    "label": "RX Success",
                    "description": """Wähle dies, um deinen Empfänger ohne Referenz zu bewerten. WSPRadar findet bestätigte Gelegenheiten, in denen eine andere qualifizierende Empfangsstation denselben entfernten Sender im selben WSPR-Zyklus decodiert. Das Outcome lautet Vom Target gehört, wenn auch der Target-Empfänger ihn decodiert, und Nur von anderen gehört, wenn dies nicht der Fall ist. Die RX Success Rate ist der Anteil bestätigter Gelegenheiten mit dem Outcome Vom Target gehört. Die Ergebnisse zeigen die eigenständige Target-Leistung, keinen Referenzvergleich.""",
                },
                "tx_success": {
                    "label": "TX Success",
                    "description": """Wähle dies, um deinen Sender ohne Referenz zu bewerten. In Zyklen, in denen das Target nachweislich sendet, bildet WSPRadar eine bestätigte Gelegenheit, wenn eine entfernte RX-Station auf demselben Band ein anderes qualifizierendes Signal decodiert. Das Outcome lautet Target gehört, wenn diese Station auch das Target decodiert, und Nur andere Signale gehört, wenn dies nicht der Fall ist. Die TX Success Rate ist der Anteil bestätigter Gelegenheiten mit dem Outcome Target gehört. Die Ergebnisse zeigen die eigenständige Target-Leistung, keinen Referenzvergleich.""",
                },
                "rx_compare": {
                    "label": "RX Compare",
