...
RESULT_GUIDANCE = {
    "en": {
        ...
        "sections": {
            ...
            "temporal_evidence_joint": {
                "read": """Temporal Evidence links ΔSNR to its support. **Δ SNR over Time** uses the selected chronological bin; **Δ SNR by UTC Hour** folds dates into 1-hour slots. Positive values favor Target; negative values favor Reference; 0 dB is equality. Red dashed line: median of all Joint Spots; pale markers: bin medians. A subtle IQR band bounded by fine Q1–Q3 lines shows the middle 50% of that same bin population only when at least five Joint Spots contribute. Color shows relative Joint-Spot density per panel, not |ΔSNR| or advantage; height gives labelled dB on the nonlinear axis. <strong class="defined-term">Compare Temporal Evidence Coverage</strong> adds Only Target, Joint and Only Reference. Upper row: each station supplies one split vote; bar height shows contributing stations, and the blue line shows their equal-weight Joint share. Lower row: comparison-unit counts; the amber line shows Joint divided by retained units. A gap between lines shows volume weighting. Folded bars average each UTC hour over represented dates. Stable same-sign medians, dense evidence and similar lines support recurrence; spikes, reversals or low Joint share deserve caution.""",
            ...
            "temporal_evidence_scheduled": {
                "read": """Temporal Evidence links Pair ΔSNR to completed-pair support. **Δ SNR over Time** uses the selected chronological bin; **Δ SNR by UTC Hour** folds dates into 1-hour slots. Positive values favor Target; negative values favor Reference; 0 dB is equality. Red dashed line: median of complete Scheduled Pairs; pale markers: bin medians. A subtle IQR band bounded by fine Q1–Q3 lines shows the middle 50% of that same bin population only when at least five complete pairs contribute. Color shows relative Scheduled-Pair density per panel, not advantage; height gives labelled dB on the nonlinear axis. <strong class="defined-term">Compare Temporal Evidence Coverage</strong> adds Only Target, Joint and Only Reference. Upper row: each receiver supplies one split vote; bar height shows contributing receivers, and the blue line shows their equal-weight completed-pair share. Lower row: scheduled A/B-unit counts; the amber line shows complete pairs divided by retained units. A gap between lines shows volume weighting. Folded bars average each UTC hour over represented dates. Stable same-sign medians, dense evidence and similar lines support recurrence; spikes, reversals or low completed-pair share deserve caution.""",
            ...
            "selected_compare_joint": {
                "read": """Selected Station Evidence isolates one chosen {peer_type} station and one specific radio path. **Δ SNR over Time** uses the selected chronological bin; **Δ SNR by UTC Hour** folds the path into 1-hour slots. Values are signed and not baseline-normalized: positive favors Target, negative favors Reference and 0 dB is equality. Red dashed line: median of all Joint Spots; pale markers: bin medians. A subtle IQR band bounded by fine Q1–Q3 lines shows the middle 50% of that same bin population only when at least five Joint Spots contribute. Color shows relative Joint-Spot density per panel, not advantage; height gives labelled dB on the nonlinear axis. Gaps mean no Joint evidence. <strong class="defined-term">Selected Path Evidence Coverage</strong> adds Only Target, Joint and Only Reference. Bars count **Retained WSPR Cycles**; the amber line shows their Joint share. Folded bars average per represented UTC date. A stable sign, dense evidence and high Joint share support a persistent path difference; reversals or long one-sided periods indicate dependence on time or conditions.""",
            ...
            "selected_compare_scheduled": {
                "read": """Selected Station Evidence isolates one RX station and one scheduled radio path. **Δ SNR over Time** uses the selected chronological bin; **Δ SNR by UTC Hour** folds the path into 1-hour slots. Values are signed and not baseline-normalized: positive favors Target, negative favors Reference and 0 dB is equality. The red dashed line is the median of complete Scheduled Pairs; pale markers are bin medians. A subtle IQR band bounded by fine Q1–Q3 lines shows the middle 50% of that same bin population only when at least five complete pairs contribute. Color shows relative Scheduled-Pair density per panel, not advantage; height gives labelled dB on the nonlinear axis. Gaps mean no complete pair was available. <strong class="defined-term">Selected Path Evidence Coverage</strong> adds Only Target, Joint and Only Reference. Bars count **Scheduled A/B Pairs**; the amber line shows the complete-pair share. Folded bars average per represented UTC date. A stable sign, dense evidence and high completed-pair share support a persistent path difference; reversals or long one-sided periods indicate dependence on time or conditions.""",
    ...
    "de": {
        ...
        "sections": {
            ...
            "temporal_evidence_scheduled": {
                "read": """Zeitliche Evidenz verbindet Pair-ΔSNR und Evidenzbasis. **Δ SNR im Zeitverlauf** nutzt gewählte Binbreite; **Δ SNR nach UTC-Stunde** faltet Tage in 1-h-Slots. Positive Werte sprechen für Target, negative für Referenz; 0 dB bedeutet Gleichheit. Rote gestrichelte Linie: Median vollständiger geplanter Paare; helle Marker: Bin-Mediane. Ein dezentes IQR-Band, begrenzt von feinen Q1–Q3-Linien, zeigt die mittleren 50 % derselben Bin-Population nur, wenn mindestens fünf vollständige Paare beitragen. Farbe: relative Dichte geplanter Paare je Panel, nicht Vorteil; Höhe: dB-Wert auf nichtlinearer Achse. <strong class="defined-term">Zeitliche Evidenzabdeckung</strong> zeigt Only Target, Joint und Only Reference. Oben liefert jede RX-Station eine aufgeteilte Stimme; die Balkenhöhe zeigt beitragende Empfänger, die blaue Linie deren gleichgewichteten Anteil vollständiger Paare. Unten: geplante A/B-Einheiten; gelbe Linie: Anteil vollständiger Paare. Linienabstand zeigt Volumengewichtung. Gefaltete Balken mitteln je UTC-Stunde über vertretene Tage. Stabiles Vorzeichen, dichte Evidenz und ähnliche Linien stützen Wiederkehr; Spitzen, Wechsel oder geringer Paaranteil mahnen zur Vorsicht.""",
            ...
            "selected_compare_scheduled": {
                "read": """Die Ansicht betrachtet eine RX-Station und einen geplanten Funkweg. **Δ SNR im Zeitverlauf** nutzt die Binbreite; **Δ SNR nach UTC-Stunde** faltet den Funkweg in 1-h-Slots. Die Werte sind vorzeichenbehaftet und nicht basisliniennormalisiert: Positiv spricht für Target, negativ für Referenz; 0 dB bedeutet Gleichheit. Rote gestrichelte Linie: Median vollständiger geplanter Paare; helle Marker: Bin-Mediane. Ein dezentes IQR-Band, begrenzt von feinen Q1–Q3-Linien, zeigt die mittleren 50 % derselben Bin-Population nur, wenn mindestens fünf vollständige Paare beitragen. Farbe: relative Dichte geplanter Paare je Panel, nicht Vorteil; Höhe: dB-Wert auf nichtlinearer Achse. Lücken bedeuten, dass kein vollständiges Paar vorlag. <strong class="defined-term">Evidenzabdeckung</strong> ergänzt Only Target, Joint und Only Reference. Balken zählen **Geplante A/B-Paare**; die gelbe Linie zeigt den vollständigen Paaranteil. Gefaltete Balken mitteln je berücksichtigtem UTC-Tag. Stabiles Vorzeichen, dichte Evidenz und hoher Paaranteil stützen einen beständigen Funkwegunterschied; Umkehrungen oder lange einseitige Phasen zeigen Zeit- oder Bedingungsabhängigkeit.""",
