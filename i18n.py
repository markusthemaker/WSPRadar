...
T = {
    "en": {
        ...
        "cbar_abs": "Median Peer Opportunity Rate (%)",
        ...
        "fig_rx_abs": "RX Confirmed-Reception Rate: {callsign}",
        "fig_rx_comp": "RX Compare: {callsign} (Target) vs. {comp_title}",
        "fig_tx_abs": "TX Conditional Network Decode Rate: {callsign}",
        ...
        "hlp_min_opportunities": "Absolute rate maps include a peer only after this many independently confirmed opportunities. Target-only observations never enter the denominator.",
        "hlp_min_stations": "Map segments require at least X eligible peer stations to be drawn.",
        ...
        "lbl_min_opportunities": "Min. Confirmed Opportunities per Peer",
        ...
        "tbl_col_hits": "Hits (H)",
        "tbl_col_misses": "Misses (M)",
        "tbl_col_target_only": "Target-Only (T)",
        "tbl_col_rate": "Confirmed Rate (%)",
        "tbl_col_success_snr": "Median Successful SNR (dB @ 1W)",
        "tbl_col_eligible": "Eligible",
        "txt_abs_selected_segment": "Selected Segment: {segment}",
        "txt_abs_evidence_summary": "Eligible peers: {eligible} / {total} | O {opportunities} | H {hits} | M {misses} | T {target_only}",
        "txt_abs_rate_summary": "Station-balanced median H/O: {median:.1f}% | Eligible-peer pooled H/O: {pooled:.1f}%",
        "txt_abs_no_eligible": "No eligible confirmed-opportunity rate in this scope.",
    ...
    "de": {
        ...
        "cbar_abs": "Median der Peer-Opportunity-Rate (%)",
        ...
        "fig_rx_abs": "RX Bestätigte Empfangsrate: {callsign}",
        "fig_rx_comp": "RX Vergleich: {callsign} (Target) vs. {comp_title}",
        "fig_tx_abs": "TX Bedingte Netzwerk-Dekodierrate: {callsign}",
        ...
        "hlp_min_opportunities": "Absolute Rate-Karten berücksichtigen einen Peer erst nach dieser Anzahl unabhängig bestätigter Opportunities. Target-only Beobachtungen gehören nie in den Nenner.",
        "hlp_min_stations": "Kartensegmente erfordern mindestens X geeignete Peer-Stationen.",
        ...
        "lbl_min_opportunities": "Min. bestätigte Opportunities pro Peer",
        ...
        "tbl_col_spots": "Spots",
        "tbl_col_opportunities": "Opportunities (O)",
        "tbl_col_hits": "Treffer (H)",
        "tbl_col_misses": "Fehlschläge (M)",
        "tbl_col_target_only": "Nur Target (T)",
        "tbl_col_rate": "Bestätigte Rate (%)",
        "tbl_col_success_snr": "Median erfolgreiches SNR (dB @ 1W)",
        "tbl_col_eligible": "Geeignet",
        "txt_abs_selected_segment": "Ausgewähltes Segment: {segment}",
        "txt_abs_evidence_summary": "Geeignete Peers: {eligible} / {total} | O {opportunities} | H {hits} | M {misses} | T {target_only}",
        "txt_abs_rate_summary": "Stationsbalancierter Median H/O: {median:.1f}% | Gepooltes H/O geeigneter Peers: {pooled:.1f}%",
        "txt_abs_no_eligible": "Keine geeignete bestätigte Opportunity-Rate in diesem Bereich.",
        "tbl_col_tx": "TX Station",
