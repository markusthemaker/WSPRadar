...
T = {
    "en": {
        ...
        "hlp_benchmark_offset_db": "Added to the reference-side SNR before \u0394 SNR is calculated. Applies to compare maps only. Buddy/local benchmarks use the reference side; A/B tests use Setup B / the reference time slot. If a calibration run shows target-reference = +1.6 dB, enter +1.6 dB.",
        ...
        "txt_benchmark_offset_note": "Reference SNR Correction: {offset:+.1f} dB applied to reference-side SNR before \u0394 SNR calculation.",
    ...
    "de": {
        ...
        "hlp_benchmark_offset_db": "Wird vor der Berechnung von \u0394 SNR zum Referenzseiten-SNR addiert. Gilt nur f\u00fcr Vergleichskarten. Buddy/lokale Benchmarks nutzen die Referenzseite; A/B-Tests nutzen Setup B / den Referenz-Zeitschlitz. Wenn ein Kalibrierlauf Ziel-Referenz = +1,6 dB ergibt, verwende +1,6 dB.",
        ...
        "txt_benchmark_offset_note": "Referenz-SNR-Korrektur: {offset:+.1f} dB wird vor der \u0394-SNR-Berechnung auf das Referenzseiten-SNR angewendet.",
