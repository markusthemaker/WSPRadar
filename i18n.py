...
T = {
    "en": {
        ...
        "msg_drilldown_no_stations_selected": "No stations selected.",
        "msg_drilldown_no_spots": "No spots available.",
        "msg_drilldown_no_scheduled_pairs": "No scheduled pairs available.",
        "msg_drilldown_no_joint_scheduled_pairs": "No joint scheduled pairs available for the selected station(s).",
        "msg_drilldown_no_joint_spots": "No joint spots available for the selected station(s).",
        "msg_drilldown_no_reference_station_details": "No reference station details available for the selected station(s).",
    ...
    "de": {
        ...
        "msg_drilldown_no_stations_selected": "Keine Stationen ausgew\u00e4hlt.",
        "msg_drilldown_no_spots": "Keine Spots verf\u00fcgbar.",
        "msg_drilldown_no_scheduled_pairs": "Keine geplanten Paare verf\u00fcgbar.",
        "msg_drilldown_no_joint_scheduled_pairs": "F\u00fcr die ausgew\u00e4hlte(n) Station(en) sind keine gemeinsamen geplanten Paare verf\u00fcgbar.",
        "msg_drilldown_no_joint_spots": "F\u00fcr die ausgew\u00e4hlte(n) Station(en) sind keine Joint Spots verf\u00fcgbar.",
        "msg_drilldown_no_reference_station_details": "F\u00fcr die ausgew\u00e4hlte(n) Station(en) sind keine Details zu Referenzstationen verf\u00fcgbar.",
