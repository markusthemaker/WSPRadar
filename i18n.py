...
T = {
    "en": {
        ...
        'fig_compare_coverage_folded_unavailable': "UTC-hour pattern unavailable — requires comparison evidence from at least 2 UTC dates.",
    ...
    "de": {
        ...
        'fig_compare_coverage_folded_unavailable': "UTC-Stundenmuster nicht verfügbar — erfordert Compare-Evidenz aus mindestens 2 UTC-Tagen.",
