...
T = {
    "en": {
        ...
        "lbl_show_zero_hits": "Show Zero-Hits",
        ...
        "leg_abs_hit": "H (Hit)",
        "leg_abs_hit_one": "Hit (H) = 1",
        "leg_abs_hit_mid": "Hit (H) = 2-5",
        "leg_abs_hit_high": "Hit (H) > 5",
        "leg_abs_miss": "M (Miss)",
        "leg_abs_no_hm": "No H/M evidence",
        ...
        "txt_abs_evidence_summary": "Confirmed evidence (Hit+Miss >= {threshold} per station): Hits {hits} | Misses {misses}",
        "txt_abs_rate_summary": "Success Rate Hit/(Hit+Miss): Average by Station {station_average:.1f}% | Observation-Level {overall:.1f}%",
        "txt_abs_no_eligible": "No station meets the confirmed Hit+Miss threshold in this scope.",
    ...
    "de": {
        ...
        "lbl_show_zero_hits": "Zero-Hit-Stationen zeigen",
        ...
        "leg_abs_no_hm": "Keine H/M-Evidenz",
        ...
        "txt_abs_evidence_summary": "Bestätigte Evidenz (Treffer+Fehlschlag >= {threshold} pro Station): Treffer {hits} | Fehlschläge {misses}",
        "txt_abs_rate_summary": "Erfolgsrate Treffer/(Treffer+Fehlschlag): Stationsmittel {station_average:.1f}% | Beobachtungsebene {overall:.1f}%",
        "txt_abs_no_eligible": "Keine Station erreicht in diesem Bereich den bestätigten Treffer+Fehlschlag-Schwellenwert.",
        "tbl_col_tx": "TX Station",
