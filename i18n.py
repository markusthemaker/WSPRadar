...
T = {
    "en": {
        ...
        "dev_credit": f"Release {APP_VERSION}<span class='pc-break'><br></span><span class='mobile-pipe'> | </span>License: <a href='https://github.com/markusthemaker/WSPRadar/blob/main/LICENSE' target='_blank' style='color:#39ff14; text-decoration:none;'>AGPLv3</a> | Data: <a href='{DB_URL}' style='color:#39ff14; text-decoration:none;'>wspr.live</a> | Repo: <a href='https://github.com/markusthemaker/WSPRadar/' target='_blank' style='color:#39ff14; text-decoration:none;'>GitHub</a> | Developed by Dr. Markus Brosch (DL1MKS) ",
    ...
    "de": {
        ...
        "dev_credit": f"Release {APP_VERSION}<span class='pc-break'><br></span><span class='mobile-pipe'> | </span>Lizenz: <a href='https://github.com/markusthemaker/WSPRadar/blob/main/LICENSE' target='_blank' style='color:#39ff14; text-decoration:none;'>AGPLv3</a> | Daten: <a href='{DB_URL}' style='color:#39ff14; text-decoration:none;'>wspr.live</a> | Repo: <a href='https://github.com/markusthemaker/WSPRadar/' target='_blank' style='color:#39ff14; text-decoration:none;'>GitHub</a> | Entwickelt von Dr. Markus Brosch (DL1MKS) ",
