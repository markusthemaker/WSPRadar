...
T = {
    "en": {
        ...
        "lbl_qth": "QTH Locator (4 or 6 chars)",
        ...
        "ph_reference_callsign": "e.g. Callsign/P",
        ...
        "err_callsign_format": "Enter a plausible callsign/reporting identifier: 3-15 ASCII characters, with at least one slash-separated segment containing both a letter and a digit; use '/' only between non-empty segments.",
        "err_qth_format": "Enter a valid 4- or 6-character Maidenhead locator (e.g. JN37 or JN37AA).",
        "err_reference_callsign_format": "Enter a plausible Reference Callsign: 3-15 ASCII characters, with at least one slash-separated segment containing both a letter and a digit; use '/' only between non-empty segments.",
    ...
    "de": {
        ...
        "lbl_qth": "QTH-Locator (4 oder 6 Zeichen)",
        ...
        "ph_reference_callsign": "z. B. Rufzeichen/P",
        ...
        "err_callsign_format": "Bitte eine plausible Rufzeichen-/Meldekennung eingeben: 3-15 ASCII-Zeichen, wobei mindestens ein durch '/' getrennter Teil sowohl einen Buchstaben als auch eine Ziffer enth\u00e4lt; '/' nur zwischen nicht leeren Teilen verwenden.",
        "err_qth_format": "Bitte einen g\u00fcltigen 4- oder 6-stelligen Maidenhead-Locator eingeben (z. B. JN37 oder JN37AA).",
        "err_reference_callsign_format": "Bitte ein plausibles Referenz-Rufzeichen eingeben: 3-15 ASCII-Zeichen, wobei mindestens ein durch '/' getrennter Teil sowohl einen Buchstaben als auch eine Ziffer enth\u00e4lt; '/' nur zwischen nicht leeren Teilen verwenden.",
