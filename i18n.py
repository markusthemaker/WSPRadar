...
T = {
    "en": {
        ...
        "dev_credit": f"Release {APP_VERSION}<span class='pc-break'><br></span><span class='mobile-pipe'> | </span>Repo: <a href='https://github.com/markusthemaker/WSPRadar/' target='_blank' style='color:#39ff14; text-decoration:none;'>GitHub</a> | Developed by Dr. Markus Brosch (DL1MKS) ",        
