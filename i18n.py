...
T = {
    "en": {
        ...
        "hlp_benchmark_offset_db": "Added to the benchmark/reference SNR before \u0394 SNR is calculated. Applies to compare maps only. Use -1.0 dB if the benchmark/reference is known to read 1 dB too strong.",
    ...
    "de": {
        ...
        "hlp_benchmark_offset_db": "Wird vor der Berechnung von \u0394 SNR zum Benchmark-/Referenz-SNR addiert. Gilt nur f\u00fcr Vergleichskarten. Verwende -1,0 dB, wenn Benchmark/Referenz bekannterma\u00dfen 1 dB zu stark angezeigt wird.",
