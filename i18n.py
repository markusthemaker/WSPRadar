...
RESULT_GUIDANCE = {
    ...
    "de": {
        ...
        "sections": {
            ...
            "drilldown_local_median": {
                "read": """Beim Lokalen Nachbarschafts-Median listet Drill-Down die lokalen Referenzidentitäten auf, die zum Median jedes Zyklus beigetragen haben. Prüfe anhand dieser Zeilen die Zusammensetzung der Beitragenden und ihre SNR-Werte, einschließlich möglicher Änderungen der Zusammensetzung zugleich mit dem beobachteten Delta SNR. Mehrere Beitragszeilen können einen einzigen Vergleich zwischen Target und Nachbarschaft erklären; sie sind keine zusätzlichen unabhängigen gepaarten Beobachtungen.""",
                "limits": """Die Prüfung der Beitragenden unterstützt die Untersuchung der wechselnden Referenz. Sie kann für sich allein nicht bestimmen, ob eine beobachtete Änderung vom Target, von der Nachbarschaft oder von deren jeweiligen Bedingungen verursacht wurde.""",
            },
            "download": {
