...
Eine kurze betriebliche Aussage nennt Target und Referenz, TX- oder RX-Richtung, Band, UTC-Zeitfenster, geografischen Bereich, Ergebnistyp, angezeigten Wert und die stützende Stations- beziehungsweise Evidenzanzahl.
...
* die gespeicherte `.config`; halte die WSPRadar-Release- oder Git-Commit-Kennung separat fest, da der Export diese derzeit nicht erfasst;
