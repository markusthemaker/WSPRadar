...
| **Startdatum (UTC)**, **Enddatum (UTC)**, **Startzeit (UTC)**, **Endzeit (UTC)** | exakte Standardgrenzen oben | Datumswerte beginnen im Jahr 2008; ein einzelnes Fenster ist auf 31 Tage begrenzt. Das Ende muss nach dem Start liegen und darf nicht später als die aktuelle 15-Minuten-UTC-Grenze sein. Bearbeitete Werte werden auf 15-Minuten-Grenzen abgerundet und als effektive Werte in die Bedienelemente zurückgeschrieben. |
...
* Speichere die versionierte `.config`. Sie erfasst die für den Lauf zutreffenden Einstellungen:
    ...
    * **dauerhafte Einstellungen der Ergebnisansicht:** ausgewählte Entfernungs- und Richtungsbereiche, die ausgewählte Station, Evidenz-Zeitklassen und Zeitansicht sowie die Sichtbarkeit ungepaarter Evidenz oder von Evidenz ohne Target-Beobachtung.
