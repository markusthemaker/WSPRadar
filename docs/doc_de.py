...
Die weißen verbundenen Marker bleiben eine eigene Statistik: Sie zeigen den Median innerhalb jeder belegten Zeitklasse. Feine Q1- und Q3-Linien verwenden dieselben rohen Werte der Joint Spots beziehungsweise vollständigen Scheduled Pairs vor der Rundung in ganzzahlige Heatmap-Klassen und vor der nichtlinearen Darstellungstransformation. Sie erscheinen erst ab fünf beitragenden Werten, werden an nicht ausreichend gestützten Bins unterbrochen und lassen schwach gestützte Mediane sichtbar. Die Linien beschreiben die mittleren 50 % eines Bins und weder Unsicherheit noch ein Konfidenzintervall; sie verändern nicht die vollständige endliche Evidenzspanne der Achse.
