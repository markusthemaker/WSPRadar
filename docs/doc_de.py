...
* Die Zeitbin-Auswahl oberhalb des rechten Panels wirkt nur auf die Zeit-Heatmap. `1h`, `3h`, `7h`, `12h` und `24h` definieren feste UTC-Bins, mit `3h` als Standard. Die Heatmap aggregiert alle ausgew&auml;hlten Zeilen in ganzzahlige SNR- oder Delta-SNR-Dichtezellen, legt Medianmarker dar&uuml;ber und verbindet benachbarte Mediane nur, wenn beide benachbarten Bins mindestens drei Punkte enthalten. Das Verteilungspanel bleibt roh, damit die vollst&auml;ndige ausgew&auml;hlte Evidenzpopulation sichtbar bleibt.
