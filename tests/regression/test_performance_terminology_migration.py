...
TARGETED_RENDERER_PATHS = (
    ...
    "ui/components/inspector_common.py",
    "ui/components/inspector_export.py",
    "ui/components/inspector_scope.py",
    "ui/components/inspector_stations.py",
    "ui/components/inspector_selected.py",
    "ui/components/inspector_outliers.py",
    "ui/inspector/preparation.py",
    "ui/inspector/presentation.py",
